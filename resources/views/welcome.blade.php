  ...
  <body class="pushable">
    <div class="pusher">
      <div class="ui vertical masthead center aligned segment">
        <div class="ui large fixed inverted pointing menu">
          <div class="ui container">
            <div class="header item"><i class="blue large rocket icon"></i>Welcome to Rocket</div>
            <div class="right menu">
              <div class="item">
                <div class="ui action input">
                  <input type="text" placeholder="Search in Rocket">
                  <button class="ui compact icon blue button"><i class="search icon"></i></button>
                </div>
              </div>
              <div class="ui dropdown item">
                <i class="blue sign in icon"></i>
                Log in
                <div class="menu">
                  <a class="item"><i class="user icon"></i> Account</a>
                  <div class="column">
          ...
          <div class="column">
            <div class="ui blue segment">
              <form class="ui large form">
                ...
                <button class="ui primary button" type="submit">Sign up for Rocket</button>
              </form>
            </div>
          </div>
          <div class="column">
